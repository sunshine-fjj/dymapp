                ...
                if(checkedBoxs.length < 1){
                    ...
                    $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
                        if(r){
                            // alert("删除："+ids.get());
                            // 发送请求
                            window.location = "${ctx }/diagnose/removeDiagnose?ids=" + ids.get();
                        }
                    });
                }
            })
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td class="main_locbg font2"><img src="${ctx }/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：自诊中心&gt; 故障信息查询</td>
    ...
    <table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
      ...
      <tr valign="top">
        <td height="30">
          <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
            <tr>
              <td class="fftd">
                  <form name="diagnoseform" method="post" id="diagnoseform" action="${ctx }/diagnose/selectDiagnose">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="font3">
            ...
            <c:forEach items="${requestScope.diagnoses}" var="diagnose" varStatus="stat">
                <tr ondblclick="down(${diagnose.id});"  class="main_trbg" align="center" id="data_${stat.index}">
                    <td><input type="checkbox" id="box_${stat.index}" value="${diagnose.id}"></td>
                     ...
                     <td align="center" width="40px;"><a href="${ctx }/diagnose/updateDiagnose?flag=1&id=${diagnose.id}">
      ...
      <tr valign="top"><td align="center" class="font3">
             <fkjava:pager 
                ...
                style="digg"
                submitUrl="${ctx}/diagnose/selectDiagnose?pageIndex={0}"
                />
      </td></tr>
    </table>
    <div style="height:10px;"></div>
    
    <!-- <a href="D:\eclipse-ee\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\dymapp\upload\截图信息.doc">点这里</a> -->
</body>
</html>