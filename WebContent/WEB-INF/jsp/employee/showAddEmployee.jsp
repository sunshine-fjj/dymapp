...
<html>
    <head>
    <title>电脑医院信息管理与预约系统——添加员工</title>
         ...
         <form action="${ctx}/employee/addEmployee" id="employeeForm" method="post">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
            <tr><td class="font3 fftd">
                <table>
                    <tr>
                        <td class="font3 fftd">姓名：<input type="text" name="realname" id="realname" size="20"/></td>
                        <td class="font3 fftd">班级：<input type="text" name="realclass" id="realclass" size="20"/></td>
                    </tr>
                    
                     <tr>
                        <td class="font3 fftd">电话：<input name="phonenum" id="phonenum" size="20"/></td>
                    	<td class="font3 fftd">政治面貌：<input name="party" id="party" size="20"/>
                    </tr>
                    <tr>
                        ...
                        <td class="font3 fftd">职位：
                         <select name="position" style="width:143px;">
                    ...
                    <tr>
                    	...
                    	<td class="font3 fftd">编号：<input type="text" name="empnum" id="empnum" size="20"/></td>
