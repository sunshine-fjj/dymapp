...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>电脑医院信息管理与预约系统 ——后台管理</title>
        ...
        <table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
          ...
          <tr valign="top" id="submenu1" style="display: none">
            <td class="left_nav_bgshw" height="50">
              <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="user/selectUser" target="main">查询用户</a></img></p>
          ...
          <tr valign="top" id="submenu2" style="display: none">
            <td class="left_nav_bgshw" height="50">
              <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="employee/selectEmployee" target="main">查询员工</a></img></p>
              <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="employee/addEmployee?flag=1" target="main">添加员工</a></img></p>  
            </td>
          </tr>
          <tr><td height="2"></td></tr>
          <tr><td id="navbg3" class="left_nav_closed" ><div class="font1">公告管理</div></td></tr>
          
          <tr valign="top" id="submenu3" style="display: none">
            <td class="left_nav_bgshw tdbtmline" height="50">
              <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/notice/selectNotice?flag=1" target="main">查询公告</a></img></p>
          ...
          <tr valign="top" id="submenu4" style="display: none">
            <td class="left_nav_bgshw tdbtmline" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/appointment/selectAppointment" target="main">查询预约</a></img></p>
            </td>
          </tr>
         <tr><td id="navbg5" class="left_nav_closed" onClick="showsubmenu(5)"><div class="font1">自诊中心</div></td></tr>
          <tr valign="top" id="submenu5" style="display: none">
            <td class="left_nav_bgshw tdbtmline" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/diagnose/selectDiagnose" target="main">查看故障信息</a></img></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/diagnose/addDiagnose?flag=1" target="main">上传故障信息</a></img></p>
            </td>
          </tr>
          ...
          <tr valign="top"><td height="100%" align="center"><div class="copycct"><br /></br></br>
          <strong>河南中医药大学：</strong><br><strong>电脑医院信息管理与预约系统</strong><br><strong>电话：0371-123456</strong></td></tr>
