            ...
            <tr><td class="font3 fftd">
                <table>
                    <tr>
                        ...
                        <td class="font3 fftd">班&nbsp;级：<input type="text" name="realclass" id="realclass" size="20"/></td>
                    </tr>
                    <tr>
                        <td class="font3 fftd">电&nbsp;话：<input type="text" name="phonenum" id="phonenum" size="20"/></td>
